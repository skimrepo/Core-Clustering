...
from core_clustering.cli_contrastive_v2 import main
...
def test_cli_contrastive_v2_trains_and_saves_checkpoint(tmp_path):
...
def test_cli_contrastive_v2_force_skips_existing_checkpoint(tmp_path, capsys):
    output_dir = str(tmp_path / "outputs")
